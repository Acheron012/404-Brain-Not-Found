...
| **2** | `effective_energy <= 0.1 AND action="proceed" AND remaining_hours >= 3` | Insufficient sustained focus | **proceed → compress** | "effective_energy is 0.1, cannot maintain 3+ hour focus" |
